...
<div class="main-thumbnail-part">
	...
	<div class="container-fluid center">
		<div class="row"><div class="col-md-4"><div class="main-thumbnail-box">
					<div><img src="images/pc/pc1.jpg" class="main-thumbnail-img">
					</div> 
			...
			<div class="col-md-4"><div class="main-thumbnail-box">
					<div><img src="images/pc/pc2.jpg" class="main-thumbnail-img">
					</div>
					<div class="main-thumbnail-description">
			...
			<div class="col-md-4"><div class="main-thumbnail-box">
					<div><img src="images/pc/pc3.jpg" class="main-thumbnail-img">
					</div>
					<div class="main-thumbnail-description">
		...
		<div class="row"><div class="col-md-4"><div class="main-thumbnail-box">
					<div><img src="images/pc/pc4.png" class="main-thumbnail-img">
					</div>
					<div class="main-thumbnail-description">
			...
			<div class="col-md-4"><div class="main-thumbnail-box">
					<div><img src="images/pc/pc5.png" class="main-thumbnail-img">
					</div>
					<div class="main-thumbnail-description">
			...
			<div class="col-md-4"><div class="main-thumbnail-box">
					<div><img src="images/pc/pc6.jpg" class="main-thumbnail-img">
					</div>
					<div class="main-thumbnail-description">
		...
		<div class="row"><div class="col-md-4"><div class="main-thumbnail-box">
					<div><img src="images/pc/pc7.jpg" class="main-thumbnail-img">
					</div>
					<div class="main-thumbnail-description">
			...
			<div class="col-md-4"><div class="main-thumbnail-box">
					<div><img src="images/pc/pc8.jpg" class="main-thumbnail-img">
					</div>
					<div class="main-thumbnail-description">
			...
			<div class="col-md-4"><div class="main-thumbnail-box">
					<div><img src="images/pc/pc9.jpg" class="main-thumbnail-img">
					</div>
					<div class="main-thumbnail-description">
